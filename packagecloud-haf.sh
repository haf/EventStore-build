...
yum_repo_path=/etc/yum.repos.d/haf_oss.repo
yum_repo_config_url="https://packagecloud.io/install/repositories/haf/oss/config_file.repo?os=${os}&dist=${major_version}&name=${host}&source=script"
...
yum install -y yum-utils --disablerepo='haf_oss'
